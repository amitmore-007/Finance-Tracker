        ...
        >
          ...
          <div style={{ 
            ...
            <Dialog open={showForm} onOpenChange={setShowForm}>
              ...
              <DialogContent>
                <DialogTitle style={{ display: 'none' }}>Create Budget</DialogTitle>
                <BudgetForm
            ...
            {budgets.length === 0 ? (
              ...
              >
                ...
                <Dialog open={showForm} onOpenChange={setShowForm}>
                  ...
                  <DialogContent>
                    <DialogTitle style={{ display: 'none' }}>Create Your First Budget</DialogTitle>
                    <BudgetForm
                      onSubmit={handleAddBudget}
                      onCancel={() => setShowForm(false)}
                      existingCategories={existingCategories}
                    ...
                    return (
                      <motion.div
                        ...
                        style={{
                          ...
                          border: `3px solid ${isOverBudget ? '#ef4444' : isNearLimit ? '#f59e0b' : 'rgba(102, 126, 234, 0.2)'}`,
                          borderRadius: '24px',
                          padding: '32px',
                      ...
                      >
                        ...
                        <div style={{ 
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                            <motion.div
                              ...
                              style={{
                                ...
                                justifyContent: 'center',
                                fontSize: '28px',
                                background: `linear-gradient(135deg, ${category?.color || '#8395A7'}30, ${category?.color || '#8395A7'}60)`,
                                border: `3px solid ${category?.color || '#8395A7'}`,
                                boxShadow: `0 12px 30px ${category?.color || '#8395A7'}30`
                              }}
                            >
                              {category?.icon || '📦'}
                            </motion.div>
                              ...
                              <div style={{ 
                                ...
                                {isOverBudget && (
                                  ...
                                  >
                                    ...
                                    <span style={{ fontSize: '13px', fontWeight: '700' }}>Over Budget</span>
                                  </motion.div>
                                )}
                                {isNearLimit && !isOverBudget && (
                                  ...
                                  >
                                    <AlertTriangle size={16} />
                                    <span style={{ fontSize: '13px', fontWeight: '700' }}>Near Limit</span>
                                  </motion.div>
                                )}
                                {percentage <= 80 && (
                                  <motion.div 
                                  ...
                                  >
                                    <CheckCircle size={16} />
                                    <span style={{ fontSize: '13px', fontWeight: '700' }}>On Track</span>
                                  </motion.div>
                                )}
                              </div>
                            </div>
                          ...
                          <div style={{ display: 'flex', gap: '12px' }}>
                            <Dialog open={editingBudget?._id === budget._id} onOpenChange={(open) => {
                              ...
                              <DialogContent>
                                <DialogTitle style={{ display: 'none' }}>Edit Budget</DialogTitle>
                                <BudgetForm
                            ...
                            <motion.button
                              ...
                              onClick={() => { if (budget._id) handleDeleteBudget(budget._id); }}
                            >
                              <Trash2 size={18} />
                            </motion.button>
                          </div>
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            <div style={{ 
                              fontSize: '18px', 
                              fontWeight: '800', 
                              color: budget.amount - budget.spent >= 0 ? '#4f46e5' : '#dc2626'
                            }}>
